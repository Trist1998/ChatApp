 ...
 */
public class NetworkMessageQueue extends DatabaseTable 
{
    ...
    private NetworkMessage message; // Declare instance of ProtocolMessage.

    /**
     * Parameterized Constructor for ProtocolQueue class, sets current protocol message to passed in parameter.
     * @param message 
     */
    public NetworkMessageQueue(NetworkMessage message) 
    {
     ...
     * @throws SQLException 
     */
    public void addToQueue(NetworkMessage message) throws SQLException 
    {
